/* ****************************************************************************************
   Example #3: Demo how to use full, partial and mono updates.
   ...
   Created by Robert Poser, July 17th 2017, Dresden/Germany
**************************************************************************************** */
...
void setup() {
    ...
    delay(1000);
    display.drawRect(9, 51, 125, 14, EPD_BLACK);
    display.update(EPD_UPD_MONO);
    for (int i=1; i<18; i++) {
        display.fillRect(6 + 7*i, 53, 5, 10, EPD_BLACK);
        display.update(EPD_UPD_MONO);
    }
}
